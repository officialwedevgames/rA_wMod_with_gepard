...
enum e_pc_permission : uint32 {
	...
	PC_PERM_VIP_PARTY_BONUS		= 0x8000000,
	PC_PERM_VIP_CASH_DISCOUNT	= 0x20000000,
	PC_PERM_VIP_GEMSTONE		= 0x40000000,
	PC_PERM_TRADE_RENTAL		= 0x80000000, // Judas Rental
...
static const struct s_pcg_permission_name {
	...
	{ "vip_party_bonus", PC_PERM_VIP_PARTY_BONUS },
