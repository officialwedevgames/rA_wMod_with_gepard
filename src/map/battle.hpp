...
// eAthena additions
	...
	int announce_refine_armor;
	int announce_refine_weapon_lvl_1;
	int announce_refine_weapon_lvl_2;
	int announce_refine_weapon_lvl_3;
	int announce_refine_weapon_lvl_4;
	// Judas Points
	int cashshop_db;
	
	// Partner Account
	int partner_account;
	int partner_exp_penalty_base;
	int partner_exp_penalty_job;
	int partner_base_exp_increase;
	int partner_job_exp_increase;
	int partner_drop_increase;
